...
//////////////////////////////////////////////////////////////////////////
void  laser_apply(_S_LASER_OBJECT *pObj,double deltaTick)
{
	switch(pObj->m_nFSM) {
		case 0:
		break;
...
void laser_draw(_S_LASER_OBJECT *pObj,_S_MAP_OBJECT *pMapBuf)
{
	switch(pObj->m_nFSM) {
	case 0:
	break;
...
void laser_fire(_S_LASER_OBJECT *pObj,
int x,int y,
double speed,double vx,double vy,
double lifeLimit)
{
...
void laser_init(_S_LASER_OBJECT *pObj,
double x,double y,double speed,
_S_MAP_OBJECT *pBody)
{
	...
	pObj->pfApply = laser_apply;
	pObj->pfDraw = laser_draw;
	pObj->pfFire = laser_fire;
